...
flag = int(b'LITCTF{w3_4r3_l1k3_saaaaaaaaaaaaaaaaaaa}'.hex(),16);
...
# print(matrix, (matrix[0][0] + matrix[1][1] + matrix[2][2]) % p, file=sys.stderr)
...
for i in range(n + 1):
	...
	# print(x, y, new_matrix, (new_matrix[0][0] + new_matrix[1][1] + new_matrix[2][2]) % p, file=sys.stderr)
