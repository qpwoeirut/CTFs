...
public final class UShortArray implements Collection<UShort>, KMappedMarker {
    ...
    public static final /* synthetic */ UShortArray m493boximpl(short[] sArr) {
        return new UShortArray(sArr);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static short[] m495constructorimpl(short[] sArr) {
        Intrinsics.checkNotNullParameter(sArr, "storage");
        return sArr;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m498equalsimpl(short[] sArr, Object obj) {
        return (obj instanceof UShortArray) && Intrinsics.areEqual((Object) sArr, (Object) ((UShortArray) obj).m509unboximpl());
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m499equalsimpl0(short[] sArr, short[] sArr2) {
    ...
    public boolean equals(Object obj) {
        return m498equalsimpl(this.storage, obj);
    }
    ...
    public final /* bridge */ boolean contains(Object obj) {
        ...
        return m508containsxj2QHRw(((UShort) obj).m492unboximpl());
    }
    ...
    /* renamed from: constructor-impl  reason: not valid java name */
    public static short[] m494constructorimpl(int i) {
        return m495constructorimpl(new short[i]);
    }

    /* renamed from: get-Mh2AYeg  reason: not valid java name */
    public static final short m500getMh2AYeg(short[] sArr, int i) {
        return UShort.m443constructorimpl(sArr[i]);
    }

    /* renamed from: set-01HTLdE  reason: not valid java name */
    public static final void m505set01HTLdE(short[] sArr, int i, short s) {
        sArr[i] = s;
    }
    ...
    public static java.util.Iterator<UShort> m504iteratorimpl(short[] sArr) {
    ...
    private static final class Iterator implements java.util.Iterator<UShort>, KMappedMarker {
        ...
        public /* bridge */ /* synthetic */ Object next() {
            return UShort.m437boximpl(m510nextMh2AYeg());
        }
    ...
    public static boolean m497containsAllimpl(short[] r3, java.util.Collection<kotlin.UShort> r4) {
        /*
        ...
        L_0x0032:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.UShortArray.m497containsAllimpl(short[], java.util.Collection):boolean");
    }
