...
public final class UStringsKt {
    ...
    public static final byte toUByte(String str) {
        ...
        if (uByteOrNull != null) {
            return uByteOrNull.m232unboximpl();
        }
    ...
    public static final short toUShort(String str) {
        ...
        if (uShortOrNull != null) {
            return uShortOrNull.m492unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final int toUInt(String str) {
        ...
        if (uIntOrNull != null) {
            return uIntOrNull.m310unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final long toULong(String str) {
        ...
        if (uLongOrNull != null) {
            return uLongOrNull.m388unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        int r1 = uIntOrNull.m310unboximpl();
        if (UnsignedKt.uintCompare(r1, UInt.m259constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m177boximpl(UByte.m183constructorimpl((byte) r1));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int r1 = uIntOrNull.m310unboximpl();
        if (UnsignedKt.uintCompare(r1, UInt.m259constructorimpl(SupportMenu.USER_MASK)) > 0) {
            return null;
        }
        return UShort.m437boximpl(UShort.m443constructorimpl((short) r1));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int r3 = UInt.m259constructorimpl(i);
        int i4 = 119304647;
        while (i2 < length) {
            ...
            if (UnsignedKt.uintCompare(i3, i4) > 0) {
                if (i4 == 119304647) {
                    i4 = UnsignedKt.m512uintDivideJ1ME1BU(-1, r3);
                    if (UnsignedKt.uintCompare(i3, i4) > 0) {
                    }
                }
                return null;
            }
            int r2 = UInt.m259constructorimpl(i3 * r3);
            int r7 = UInt.m259constructorimpl(UInt.m259constructorimpl(digitOf) + r2);
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long r5 = ULong.m337constructorimpl((long) i2);
        long j = 0;
        ...
        while (i3 < length) {
            ...
            if (UnsignedKt.ulongCompare(j, j2) > 0) {
                if (j2 == 512409557603043100L) {
                    j2 = UnsignedKt.m514ulongDivideeb3DHEI(-1, r5);
                    if (UnsignedKt.ulongCompare(j, j2) > 0) {
                    }
                }
                return null;
            }
            long r9 = ULong.m337constructorimpl(j * r5);
            long r13 = ULong.m337constructorimpl(ULong.m337constructorimpl(((long) UInt.m259constructorimpl(digitOf)) & 4294967295L) + r9);
