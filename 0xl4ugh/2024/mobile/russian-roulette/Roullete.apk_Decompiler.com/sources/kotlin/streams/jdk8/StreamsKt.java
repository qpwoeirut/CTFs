...
public final class StreamsKt {
    ...
    public static final <T> Stream<T> asStream(Sequence<? extends T> sequence) {
        ...
        Intrinsics.checkNotNullExpressionValue(m, "stream({ Spliterators.sp…literator.ORDERED, false)");
        return m;
    }

    /* access modifiers changed from: private */
    /* renamed from: asStream$lambda-4  reason: not valid java name */
    public static final Spliterator m1450asStream$lambda4(Sequence sequence) {
    ...
    public static final <T> List<T> toList(Stream<T> stream) {
        ...
        Intrinsics.checkNotNullExpressionValue(m, "collect(Collectors.toList<T>())");
        return (List) m;
    }
