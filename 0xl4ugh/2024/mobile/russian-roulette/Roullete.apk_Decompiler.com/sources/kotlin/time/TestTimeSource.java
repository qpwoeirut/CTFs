...
public final class TestTimeSource extends AbstractLongTimeSource {
    ...
    public final void m1611plusAssignLRDsOJo(long j) {
        long j2;
        long r0 = Duration.m1523toLongimpl(j, getUnit());
        if (r0 == Long.MIN_VALUE || r0 == Long.MAX_VALUE) {
            double r2 = ((double) this.reading) + Duration.m1520toDoubleimpl(j, getUnit());
    ...
    private final void m1610overflowLRDsOJo(long j) {
        throw new IllegalStateException("TestTimeSource will overflow if its reading " + this.reading + "ns is advanced by " + Duration.m1526toStringimpl(j) + '.');
    }
}
