...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark m1471minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m1615minusLRDsOJo(this, j);
    }

    /* renamed from: getAdjustment-UwyO8pc  reason: not valid java name */
    public final long m1470getAdjustmentUwyO8pc() {
    ...
    public long m1469elapsedNowUwyO8pc() {
        return Duration.m1512minusLRDsOJo(this.mark.m1612elapsedNowUwyO8pc(), this.adjustment);
    }

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m1472plusLRDsOJo(long j) {
        return new AdjustedTimeMark(this.mark, Duration.m1513plusLRDsOJo(this.adjustment, j), (DefaultConstructorMarker) null);
    }
}
