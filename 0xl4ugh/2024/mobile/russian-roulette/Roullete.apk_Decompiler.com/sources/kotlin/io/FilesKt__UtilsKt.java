...
class FilesKt__UtilsKt extends FilesKt__FileTreeWalkKt {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:28:0x0097, code lost:
        if (r5.delete() == false) goto L_0x0099;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static final boolean copyRecursively(java.io.File r11, java.io.File r12, boolean r13, kotlin.jvm.functions.Function2<? super java.io.File, ? super java.io.IOException, ? extends kotlin.io.OnErrorAction> r14) {
        ...
        L_0x002d:
            return r1
        L_0x002e:
            kotlin.io.FileTreeWalk r0 = kotlin.io.FilesKt.walkTopDown(r11)     // Catch:{ TerminateException -> 0x00d9 }
            kotlin.io.FilesKt__UtilsKt$copyRecursively$2 r3 = new kotlin.io.FilesKt__UtilsKt$copyRecursively$2     // Catch:{ TerminateException -> 0x00d9 }
            r3.<init>(r14)     // Catch:{ TerminateException -> 0x00d9 }
            kotlin.jvm.functions.Function2 r3 = (kotlin.jvm.functions.Function2) r3     // Catch:{ TerminateException -> 0x00d9 }
            kotlin.io.FileTreeWalk r0 = r0.onFail(r3)     // Catch:{ TerminateException -> 0x00d9 }
            java.util.Iterator r0 = r0.iterator()     // Catch:{ TerminateException -> 0x00d9 }
        L_0x0041:
            boolean r3 = r0.hasNext()     // Catch:{ TerminateException -> 0x00d9 }
            if (r3 == 0) goto L_0x00d8
            java.lang.Object r3 = r0.next()     // Catch:{ TerminateException -> 0x00d9 }
            java.io.File r3 = (java.io.File) r3     // Catch:{ TerminateException -> 0x00d9 }
            boolean r4 = r3.exists()     // Catch:{ TerminateException -> 0x00d9 }
            if (r4 != 0) goto L_0x0068
            kotlin.io.NoSuchFileException r10 = new kotlin.io.NoSuchFileException     // Catch:{ TerminateException -> 0x00d9 }
            ...
            r4 = r10
            r5 = r3
            r4.<init>(r5, r6, r7, r8, r9)     // Catch:{ TerminateException -> 0x00d9 }
            java.lang.Object r3 = r14.invoke(r3, r10)     // Catch:{ TerminateException -> 0x00d9 }
            kotlin.io.OnErrorAction r4 = kotlin.io.OnErrorAction.TERMINATE     // Catch:{ TerminateException -> 0x00d9 }
            if (r3 != r4) goto L_0x0041
            return r2
        L_0x0068:
            java.lang.String r4 = kotlin.io.FilesKt.toRelativeString(r3, r11)     // Catch:{ TerminateException -> 0x00d9 }
            java.io.File r5 = new java.io.File     // Catch:{ TerminateException -> 0x00d9 }
            r5.<init>(r12, r4)     // Catch:{ TerminateException -> 0x00d9 }
            boolean r4 = r5.exists()     // Catch:{ TerminateException -> 0x00d9 }
            if (r4 == 0) goto L_0x00a9
            boolean r4 = r3.isDirectory()     // Catch:{ TerminateException -> 0x00d9 }
            if (r4 == 0) goto L_0x0083
            boolean r4 = r5.isDirectory()     // Catch:{ TerminateException -> 0x00d9 }
            if (r4 != 0) goto L_0x00a9
        L_0x0083:
        ...
        L_0x0086:
            ...
            boolean r4 = kotlin.io.FilesKt.deleteRecursively(r5)     // Catch:{ TerminateException -> 0x00d9 }
            if (r4 != 0) goto L_0x00a9
            goto L_0x0099
        L_0x0093:
            boolean r4 = r5.delete()     // Catch:{ TerminateException -> 0x00d9 }
            if (r4 != 0) goto L_0x00a9
        L_0x0099:
            kotlin.io.FileAlreadyExistsException r4 = new kotlin.io.FileAlreadyExistsException     // Catch:{ TerminateException -> 0x00d9 }
            java.lang.String r6 = "The destination file already exists."
            r4.<init>(r3, r5, r6)     // Catch:{ TerminateException -> 0x00d9 }
            java.lang.Object r3 = r14.invoke(r5, r4)     // Catch:{ TerminateException -> 0x00d9 }
            kotlin.io.OnErrorAction r4 = kotlin.io.OnErrorAction.TERMINATE     // Catch:{ TerminateException -> 0x00d9 }
            if (r3 != r4) goto L_0x0041
            return r2
        L_0x00a9:
            ...
            r5.mkdirs()     // Catch:{ TerminateException -> 0x00d9 }
            goto L_0x0041
        L_0x00b3:
            r8 = 4
            r9 = 0
            ...
            r4 = r3
            r6 = r13
            java.io.File r4 = kotlin.io.FilesKt.copyTo$default(r4, r5, r6, r7, r8, r9)     // Catch:{ TerminateException -> 0x00d9 }
            long r4 = r4.length()     // Catch:{ TerminateException -> 0x00d9 }
            long r6 = r3.length()     // Catch:{ TerminateException -> 0x00d9 }
            int r4 = (r4 > r6 ? 1 : (r4 == r6 ? 0 : -1))
            if (r4 == 0) goto L_0x0041
            java.io.IOException r4 = new java.io.IOException     // Catch:{ TerminateException -> 0x00d9 }
            java.lang.String r5 = "Source file wasn't copied completely, length of destination file differs."
            r4.<init>(r5)     // Catch:{ TerminateException -> 0x00d9 }
            java.lang.Object r3 = r14.invoke(r3, r4)     // Catch:{ TerminateException -> 0x00d9 }
            kotlin.io.OnErrorAction r4 = kotlin.io.OnErrorAction.TERMINATE     // Catch:{ TerminateException -> 0x00d9 }
            if (r3 != r4) goto L_0x0041
            return r2
        L_0x00d8:
