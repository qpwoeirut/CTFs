...
public final class Result<T> implements Serializable {
    ...
    public static final /* synthetic */ Result m164boximpl(Object obj) {
        return new Result(obj);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static <T> Object m165constructorimpl(Object obj) {
        return obj;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m166equalsimpl(Object obj, Object obj2) {
        return (obj2 instanceof Result) && Intrinsics.areEqual(obj, ((Result) obj2).m174unboximpl());
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m167equalsimpl0(Object obj, Object obj2) {
    ...
    public static int m170hashCodeimpl(Object obj) {
        if (obj == null) {
            return 0;
        }
        return obj.hashCode();
    ...
    public final /* synthetic */ Object m174unboximpl() {
        return this.value;
    }
    ...
    public static final boolean m172isSuccessimpl(Object obj) {
        return !(obj instanceof Failure);
    }

    /* renamed from: isFailure-impl  reason: not valid java name */
    public static final boolean m171isFailureimpl(Object obj) {
        return obj instanceof Failure;
    }

    /* renamed from: getOrNull-impl  reason: not valid java name */
    private static final T m169getOrNullimpl(Object obj) {
        if (m171isFailureimpl(obj)) {
            return null;
        }
        return obj;
    }
    ...
    public static final Throwable m168exceptionOrNullimpl(Object obj) {
    ...
    public static String m173toStringimpl(Object obj) {
        if (obj instanceof Failure) {
    ...
    public static final class Companion {
        ...
        private final <T> Object success(T t) {
            return Result.m165constructorimpl(t);
        }

        private final <T> Object failure(Throwable th) {
            Intrinsics.checkNotNullParameter(th, "exception");
            return Result.m165constructorimpl(ResultKt.createFailure(th));
        }
    }
