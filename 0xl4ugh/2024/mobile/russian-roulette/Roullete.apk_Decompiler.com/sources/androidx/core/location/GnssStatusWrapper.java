...
class GnssStatusWrapper extends GnssStatusCompat {
    ...
    GnssStatusWrapper(Object obj) {
        this.mWrapped = HalfKt$$ExternalSyntheticApiModelOutline0.m(Preconditions.checkNotNull(HalfKt$$ExternalSyntheticApiModelOutline0.m(obj)));
    }
    ...
    public int getConstellationType(int i) {
        return HalfKt$$ExternalSyntheticApiModelOutline0.m$1(this.mWrapped, i);
    }

    public int getSvid(int i) {
        return HalfKt$$ExternalSyntheticApiModelOutline0.m(this.mWrapped, i);
    }
    ...
    public float getElevationDegrees(int i) {
        return HalfKt$$ExternalSyntheticApiModelOutline0.m$2(this.mWrapped, i);
    }
