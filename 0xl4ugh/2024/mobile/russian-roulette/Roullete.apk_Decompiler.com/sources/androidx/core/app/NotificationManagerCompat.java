...
public final class NotificationManagerCompat {
    ...
    public boolean areNotificationsEnabled() {
        if (Build.VERSION.SDK_INT >= 24) {
            return BitmapKt$$ExternalSyntheticApiModelOutline0.m(this.mNotificationManager);
        }
        ...
        try {
            ...
            Method method = cls.getMethod(CHECK_OP_NO_THROW, new Class[]{Integer.TYPE, Integer.TYPE, String.class});
    ...
    public int getImportance() {
        return Build.VERSION.SDK_INT >= 24 ? BitmapKt$$ExternalSyntheticApiModelOutline0.m(this.mNotificationManager) : IMPORTANCE_UNSPECIFIED;
    }
    ...
    public void deleteNotificationChannel(String str) {
        if (Build.VERSION.SDK_INT >= 26) {
            BitmapKt$$ExternalSyntheticApiModelOutline0.m(this.mNotificationManager, str);
        }
    }
    ...
    public void deleteUnlistedNotificationChannels(Collection<String> collection) {
        if (Build.VERSION.SDK_INT >= 26) {
            for (Object m : BitmapKt$$ExternalSyntheticApiModelOutline0.m(this.mNotificationManager)) {
                NotificationChannel m2 = ComponentDialog$$ExternalSyntheticApiModelOutline0.m(m);
                if (!collection.contains(ComponentDialog$$ExternalSyntheticApiModelOutline0.m(m2)) && (Build.VERSION.SDK_INT < 30 || !collection.contains(ComponentDialog$$ExternalSyntheticApiModelOutline0.m$1(m2)))) {
                    BitmapKt$$ExternalSyntheticApiModelOutline0.m(this.mNotificationManager, ComponentDialog$$ExternalSyntheticApiModelOutline0.m(m2));
                }
            }
        }
    }
    ...
    public NotificationChannel getNotificationChannel(String str) {
        if (Build.VERSION.SDK_INT >= 26) {
            return BitmapKt$$ExternalSyntheticApiModelOutline0.m(this.mNotificationManager, str);
        }
        return null;
    }
    ...
    public NotificationChannelGroup getNotificationChannelGroup(String str) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            for (NotificationChannelGroup m : getNotificationChannelGroups()) {
                NotificationChannelGroup m2 = BitmapKt$$ExternalSyntheticApiModelOutline0.m((Object) m);
                if (ComponentDialog$$ExternalSyntheticApiModelOutline0.m(m2).equals(str)) {
                    return m2;
                }
            }
        }
    ...
    public List<NotificationChannelCompat> getNotificationChannelsCompat() {
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            if (!notificationChannels.isEmpty()) {
                ...
                for (NotificationChannel m : notificationChannels) {
                    arrayList.add(new NotificationChannelCompat(ComponentDialog$$ExternalSyntheticApiModelOutline0.m((Object) m)));
                }
                return arrayList;
            }
        }
    ...
    public List<NotificationChannelGroupCompat> getNotificationChannelGroupsCompat() {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            if (!notificationChannelGroups.isEmpty()) {
                ...
                for (NotificationChannelGroup m : notificationChannelGroups) {
                    NotificationChannelGroup m2 = BitmapKt$$ExternalSyntheticApiModelOutline0.m((Object) m);
                    if (Build.VERSION.SDK_INT >= 28) {
                        arrayList.add(new NotificationChannelGroupCompat(m2));
                    } else {
                        arrayList.add(new NotificationChannelGroupCompat(m2, list));
                    }
                }
                return arrayList;
            }
