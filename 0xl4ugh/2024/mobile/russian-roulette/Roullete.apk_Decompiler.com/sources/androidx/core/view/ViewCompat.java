...
public class ViewCompat {
    ...
    private static final OnReceiveContentViewBehavior NO_OP_ON_RECEIVE_CONTENT_VIEW_BEHAVIOR = new ViewCompat$$ExternalSyntheticLambda1();
    @Deprecated
    ...
    public static void setPointerIcon(View view, PointerIconCompat pointerIconCompat) {
        if (Build.VERSION.SDK_INT >= 24) {
            Api24Impl.setPointerIcon(view, HalfKt$$ExternalSyntheticApiModelOutline0.m(pointerIconCompat != null ? pointerIconCompat.getPointerIcon() : null));
        }
    }
