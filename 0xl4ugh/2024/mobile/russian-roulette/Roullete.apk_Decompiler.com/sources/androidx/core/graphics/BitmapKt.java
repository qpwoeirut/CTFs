...
public final class BitmapKt {
    ...
    public static /* synthetic */ Bitmap createBitmap$default(int i, int i2, Bitmap.Config config, boolean z, ColorSpace colorSpace, int i3, Object obj) {
        ...
        if ((i3 & 16) != 0) {
            colorSpace = ColorSpace.get(BitmapKt$$ExternalSyntheticApiModelOutline0.m());
            Intrinsics.checkNotNullExpressionValue(colorSpace, "get(ColorSpace.Named.SRGB)");
        }
        Intrinsics.checkNotNullParameter(config, "config");
        Intrinsics.checkNotNullParameter(colorSpace, "colorSpace");
        Bitmap m = Bitmap.createBitmap(i, i2, config, z, colorSpace);
        Intrinsics.checkNotNullExpressionValue(m, "createBitmap(width, heig…ig, hasAlpha, colorSpace)");
        return m;
    }
