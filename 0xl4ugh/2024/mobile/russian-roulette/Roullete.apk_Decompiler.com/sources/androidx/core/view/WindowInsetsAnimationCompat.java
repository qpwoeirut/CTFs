...
public final class WindowInsetsAnimationCompat {
    ...
    private static class Impl30 extends Impl {
        ...
        Impl30(int i, Interpolator interpolator, long j) {
            this(WindowInsetsCompat$Impl28$$ExternalSyntheticApiModelOutline0.m(i, interpolator, j));
        }

        public int getTypeMask() {
            return WindowInsetsCompat$Impl28$$ExternalSyntheticApiModelOutline0.m(this.mWrapped);
        }
        ...
        public long getDurationMillis() {
            return HalfKt$$ExternalSyntheticApiModelOutline0.m(this.mWrapped);
        }
        ...
        private static class ProxyCallback extends WindowInsetsAnimation$Callback {
            ...
            public WindowInsets onProgress(WindowInsets windowInsets, List<WindowInsetsAnimation> list) {
                ...
                for (int size = list.size() - 1; size >= 0; size--) {
                    WindowInsetsAnimation m = WindowInsetsCompat$Impl28$$ExternalSyntheticApiModelOutline0.m((Object) list.get(size));
                    WindowInsetsAnimationCompat windowInsetsAnimationCompat = getWindowInsetsAnimationCompat(m);
                    windowInsetsAnimationCompat.setFraction(WindowInsetsCompat$Impl28$$ExternalSyntheticApiModelOutline0.m(m));
        ...
        public static WindowInsetsAnimation.Bounds createPlatformBounds(BoundsCompat boundsCompat) {
            WindowInsetsCompat$Impl28$$ExternalSyntheticApiModelOutline0.m();
            return WindowInsetsCompat$Impl28$$ExternalSyntheticApiModelOutline0.m(boundsCompat.getLowerBound().toPlatformInsets(), boundsCompat.getUpperBound().toPlatformInsets());
        }
