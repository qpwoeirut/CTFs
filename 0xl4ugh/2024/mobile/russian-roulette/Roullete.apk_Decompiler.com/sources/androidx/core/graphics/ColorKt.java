...
public final class ColorKt {
    ...
    public static final float getLuminance(int i) {
        return HalfKt$$ExternalSyntheticApiModelOutline0.m(i);
    }

    public static final Color toColor(int i) {
        Color m = HalfKt$$ExternalSyntheticApiModelOutline0.m(i);
    ...
    public static final float component2(long j) {
        return HalfKt$$ExternalSyntheticApiModelOutline0.m$1(j);
    }
    ...
    public static final float getLuminance(long j) {
        return HalfKt$$ExternalSyntheticApiModelOutline0.m(j);
    }

    public static final Color toColor(long j) {
        Color m = HalfKt$$ExternalSyntheticApiModelOutline0.m(j);
        Intrinsics.checkNotNullExpressionValue(m, "valueOf(this)");
        return m;
    }
    ...
    public static final ColorSpace getColorSpace(long j) {
        ColorSpace m = HalfKt$$ExternalSyntheticApiModelOutline0.m(j);
