...
public class NotificationCompat {
    ...
    public static class Builder {
        ...
        public Builder(Context context, Notification notification) {
            ...
            if (Build.VERSION.SDK_INT >= 28 && (parcelableArrayList = notification.extras.getParcelableArrayList(NotificationCompat.EXTRA_PEOPLE_LIST)) != null && !parcelableArrayList.isEmpty()) {
                ...
                while (it.hasNext()) {
                    addPerson(Person.fromAndroidPerson(ComponentDialog$$ExternalSyntheticApiModelOutline0.m(it.next())));
                }
            }
    ...
    public static abstract class Style {
        ...
        private static Style constructCompatStyleByPlatformName(String str) {
            ...
            if (Build.VERSION.SDK_INT >= 24) {
                if (str.equals(ComponentDialog$$ExternalSyntheticApiModelOutline0.m().getName())) {
                    return new MessagingStyle();
                }
                if (str.equals(BitmapKt$$ExternalSyntheticApiModelOutline0.m().getName())) {
    ...
    public static class MessagingStyle extends Style {
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            if (Build.VERSION.SDK_INT >= 24) {
                if (Build.VERSION.SDK_INT >= 28) {
                    ComponentDialog$$ExternalSyntheticApiModelOutline0.m$2();
                    messagingStyle = ComponentDialog$$ExternalSyntheticApiModelOutline0.m(this.mUser.toAndroidPerson());
                } else {
                    ComponentDialog$$ExternalSyntheticApiModelOutline0.m$2();
                    messagingStyle = ComponentDialog$$ExternalSyntheticApiModelOutline0.m(this.mUser.getName());
                }
        ...
        public static final class Message {
                    ...
                    if (bundle.containsKey(KEY_TEXT)) {
                        if (bundle.containsKey(KEY_TIMESTAMP)) {
                            if (bundle.containsKey(KEY_PERSON)) {
                                ...
                                person = Person.fromAndroidPerson(ComponentDialog$$ExternalSyntheticApiModelOutline0.m((Object) bundle.getParcelable(KEY_NOTIFICATION_PERSON)));
                            }
            ...
            public android.app.Notification.MessagingStyle.Message toAndroidMessage() {
                ...
                L_0x001d:
                    android.app.Notification$MessagingStyle$Message r0 = androidx.activity.ComponentDialog$$ExternalSyntheticApiModelOutline0.m((java.lang.CharSequence) r1, (long) r4, (android.app.Person) r3)
                    goto L_0x0038
                L_0x0022:
                    androidx.activity.ComponentDialog$$ExternalSyntheticApiModelOutline0.m$3()
                    java.lang.CharSequence r1 = r6.getText()
                ...
                L_0x0034:
                    android.app.Notification$MessagingStyle$Message r0 = androidx.activity.ComponentDialog$$ExternalSyntheticApiModelOutline0.m((java.lang.CharSequence) r1, (long) r4, (java.lang.CharSequence) r3)
                L_0x0038:
                    java.lang.String r1 = r6.getDataMimeType()
                    if (r1 == 0) goto L_0x0049
                    java.lang.String r1 = r6.getDataMimeType()
                    android.net.Uri r2 = r6.getDataUri()
                    android.app.Notification.MessagingStyle.Message unused = r0.setData(r1, r2)
                L_0x0049:
                    return r0
                */
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            if (Build.VERSION.SDK_INT >= 24) {
                notificationBuilderWithBuilderAccessor.getBuilder().setStyle(ComponentDialog$$ExternalSyntheticApiModelOutline0.m());
            }
        }
    ...
    public static class Action {
        ...
        public static final class Builder {
            ...
            public static Builder fromAndroidAction(Notification.Action action) {
                ...
                if (Build.VERSION.SDK_INT >= 24) {
                    builder.mAllowGeneratedReplies = ComponentDialog$$ExternalSyntheticApiModelOutline0.m(action);
                }
                if (Build.VERSION.SDK_INT >= 28) {
                    builder.setSemanticAction(ComponentDialog$$ExternalSyntheticApiModelOutline0.m(action));
                }
    ...
    public static BubbleMetadata getBubbleMetadata(Notification notification) {
        if (Build.VERSION.SDK_INT >= 29) {
            return BubbleMetadata.fromPlatform(ComponentDialog$$ExternalSyntheticApiModelOutline0.m(notification));
        }
        return null;
    }
    ...
    static Action getActionCompatFromAction(Notification.Action action) {
        ...
        if (Build.VERSION.SDK_INT >= 24) {
            z = action.getExtras().getBoolean("android.support.allowGeneratedReplies") || ComponentDialog$$ExternalSyntheticApiModelOutline0.m(action);
        } else {
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            i = ComponentDialog$$ExternalSyntheticApiModelOutline0.m(action);
        } else {
            i = action.getExtras().getInt("android.support.action.semanticAction", 0);
        }
        int i3 = i;
        boolean m$1 = Build.VERSION.SDK_INT >= 29 ? action.isContextual() : false;
        if (Build.VERSION.SDK_INT >= 31) {
            z2 = action.isAuthenticationRequired();
        }
        boolean z5 = z2;
        if (action.getIcon() == null && action2.icon != 0) {
            return new Action(action2.icon, action2.title, action2.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z3, i3, z4, m$1, z5);
        }
        if (action.getIcon() != null) {
            iconCompat = IconCompat.createFromIconOrNullIfZeroResId(action.getIcon());
        }
        return new Action(iconCompat, action2.title, action2.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z3, i3, z4, m$1, z5);
    }
    ...
    public static List<Person> getPeople(Notification notification) {
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            if (parcelableArrayList != null && !parcelableArrayList.isEmpty()) {
                Iterator it = parcelableArrayList.iterator();
                while (it.hasNext()) {
                    arrayList.add(Person.fromAndroidPerson(ComponentDialog$$ExternalSyntheticApiModelOutline0.m(it.next())));
                }
            }
        } else {
    ...
    public static String getChannelId(Notification notification) {
        if (Build.VERSION.SDK_INT >= 26) {
            return ComponentDialog$$ExternalSyntheticApiModelOutline0.m(notification);
        }
        return null;
    }
    ...
    public static String getShortcutId(Notification notification) {
        if (Build.VERSION.SDK_INT >= 26) {
            return ComponentDialog$$ExternalSyntheticApiModelOutline0.m$1(notification);
        }
        return null;
    }
    ...
    public static LocusIdCompat getLocusId(Notification notification) {
        LocusId m;
        if (Build.VERSION.SDK_INT < 29 || (m = ComponentDialog$$ExternalSyntheticApiModelOutline0.m(notification)) == null) {
            return null;
        }
        return LocusIdCompat.toLocusIdCompat(m);
    }
