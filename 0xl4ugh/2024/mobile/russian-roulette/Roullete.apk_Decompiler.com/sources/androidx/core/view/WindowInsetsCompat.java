...
public class WindowInsetsCompat {
            ...
            if (i != 1) {
                ...
                if (i != 2) {
                    if (i == 8) {
                        ...
                        if (insets2 == null || insets2.equals(Insets.NONE) || this.mRootViewVisibleInsets.bottom <= rootStableInsets.bottom) {
                            return Insets.NONE;
                        }
                    ...
                    int i2 = systemWindowInsets2.bottom;
                    if (insets != null) {
                        i2 = Math.min(i2, insets.bottom);
                    }
                    return Insets.of(systemWindowInsets2.left, 0, systemWindowInsets2.right, i2);
                }
            } else if (z) {
    ...
    private static class Impl28 extends Impl21 {
        ...
        /* access modifiers changed from: package-private */
        public DisplayCutoutCompat getDisplayCutout() {
            return DisplayCutoutCompat.wrap(WindowInsetsCompat$Impl28$$ExternalSyntheticApiModelOutline0.m(this.mPlatformInsets));
        }

        /* access modifiers changed from: package-private */
        public WindowInsetsCompat consumeDisplayCutout() {
            return WindowInsetsCompat.toWindowInsetsCompat(WindowInsetsCompat$Impl28$$ExternalSyntheticApiModelOutline0.m(this.mPlatformInsets));
        }
    ...
    private static class Impl29 extends Impl28 {
        ...
        public Insets getTappableElementInsets() {
            if (this.mTappableElementInsets == null) {
                this.mTappableElementInsets = Insets.toCompatInsets(WindowInsetsCompat$Impl28$$ExternalSyntheticApiModelOutline0.m(this.mPlatformInsets));
            }
    ...
    private static class Impl30 extends Impl29 {
        static final WindowInsetsCompat CONSUMED = WindowInsetsCompat.toWindowInsetsCompat(WindowInsetsCompat$Impl28$$ExternalSyntheticApiModelOutline0.m());
        ...
        public Insets getInsetsIgnoringVisibility(int i) {
            return Insets.toCompatInsets(WindowInsetsCompat$Impl28$$ExternalSyntheticApiModelOutline0.m(this.mPlatformInsets, TypeImpl30.toPlatformType(i)));
        }

        public boolean isVisible(int i) {
            return WindowInsetsCompat$Impl28$$ExternalSyntheticApiModelOutline0.m(this.mPlatformInsets, TypeImpl30.toPlatformType(i));
        }
    }
    ...
    private static class BuilderImpl29 extends BuilderImpl {
        ...
        BuilderImpl29() {
            this.mPlatBuilder = WindowInsetsCompat$Impl28$$ExternalSyntheticApiModelOutline0.m();
        }
        ...
        BuilderImpl29(WindowInsetsCompat windowInsetsCompat) {
            ...
            if (windowInsets != null) {
                builder = WindowInsetsCompat$Impl28$$ExternalSyntheticApiModelOutline0.m(windowInsets);
            } else {
                builder = WindowInsetsCompat$Impl28$$ExternalSyntheticApiModelOutline0.m();
            }
        ...
        /* access modifiers changed from: package-private */
        public void setDisplayCutout(DisplayCutoutCompat displayCutoutCompat) {
            WindowInsets.Builder unused = this.mPlatBuilder.setDisplayCutout(displayCutoutCompat != null ? displayCutoutCompat.unwrap() : null);
        }
    ...
    private static class BuilderImpl30 extends BuilderImpl29 {
        ...
        /* access modifiers changed from: package-private */
        public void setInsetsIgnoringVisibility(int i, Insets insets) {
            WindowInsets.Builder unused = this.mPlatBuilder.setInsetsIgnoringVisibility(TypeImpl30.toPlatformType(i), insets.toPlatformInsets());
        }

        /* access modifiers changed from: package-private */
        public void setVisible(int i, boolean z) {
            WindowInsets.Builder unused = this.mPlatBuilder.setVisible(TypeImpl30.toPlatformType(i), z);
        }
    }
    ...
    private static final class TypeImpl30 {
        ...
        static int toPlatformType(int i) {
            ...
            for (int i4 = 1; i4 <= 256; i4 <<= 1) {
                if ((i & i4) != 0) {
                    if (i4 == 1) {
                        i2 = WindowInsetsCompat$Impl28$$ExternalSyntheticApiModelOutline0.m();
                    } else if (i4 == 2) {
                        i2 = WindowInsetsCompat$Impl28$$ExternalSyntheticApiModelOutline0.m$1();
                    } else if (i4 == 4) {
                        i2 = WindowInsetsCompat$Impl28$$ExternalSyntheticApiModelOutline0.m$2();
                    } else if (i4 == 8) {
                        i2 = WindowInsetsCompat$Impl28$$ExternalSyntheticApiModelOutline0.m$3();
                    } else if (i4 == 16) {
                        i2 = WindowInsetsCompat$Impl28$$ExternalSyntheticApiModelOutline0.m$4();
                    } else if (i4 == 32) {
                        i2 = WindowInsetsCompat$Impl28$$ExternalSyntheticApiModelOutline0.m$5();
                    } else if (i4 == 64) {
                        i2 = WindowInsetsCompat$Impl28$$ExternalSyntheticApiModelOutline0.m$6();
                    } else if (i4 == 128) {
                        i2 = WindowInsetsCompat$Impl28$$ExternalSyntheticApiModelOutline0.m$7();
                    }
                    i3 |= i2;
                }
            }
