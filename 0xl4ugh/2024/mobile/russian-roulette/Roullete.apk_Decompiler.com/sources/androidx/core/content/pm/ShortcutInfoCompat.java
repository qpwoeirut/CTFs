...
public class ShortcutInfoCompat {
    ...
    public ShortcutInfo toShortcutInfo() {
        BitmapKt$$ExternalSyntheticApiModelOutline0.m$1();
        ShortcutInfo.Builder m = BitmapKt$$ExternalSyntheticApiModelOutline0.m(this.mContext, this.mId).setShortLabel(this.mLabel).setIntents(this.mIntents);
    ...
    static List<ShortcutInfoCompat> fromShortcuts(Context context, List<ShortcutInfo> list) {
        ...
        for (ShortcutInfo m : list) {
            arrayList.add(new Builder(context, BitmapKt$$ExternalSyntheticApiModelOutline0.m((Object) m)).build());
        }
        return arrayList;
    }
    ...
    static LocusIdCompat getLocusId(ShortcutInfo shortcutInfo) {
        if (Build.VERSION.SDK_INT < 29) {
            return getLocusIdFromExtra(BitmapKt$$ExternalSyntheticApiModelOutline0.m(shortcutInfo));
        }
        if (BitmapKt$$ExternalSyntheticApiModelOutline0.m(shortcutInfo) == null) {
            return null;
        }
        return LocusIdCompat.toLocusIdCompat(BitmapKt$$ExternalSyntheticApiModelOutline0.m(shortcutInfo));
    }
    ...
    public static class Builder {
        ...
        public Builder(Context context, ShortcutInfo shortcutInfo) {
            ...
            this.mInfo = shortcutInfoCompat;
            shortcutInfoCompat.mContext = context;
            shortcutInfoCompat.mId = BitmapKt$$ExternalSyntheticApiModelOutline0.m(shortcutInfo);
            shortcutInfoCompat.mPackageName = BitmapKt$$ExternalSyntheticApiModelOutline0.m$1(shortcutInfo);
            Intent[] m = BitmapKt$$ExternalSyntheticApiModelOutline0.m(shortcutInfo);
            shortcutInfoCompat.mIntents = (Intent[]) Arrays.copyOf(m, m.length);
            shortcutInfoCompat.mActivity = BitmapKt$$ExternalSyntheticApiModelOutline0.m(shortcutInfo);
            shortcutInfoCompat.mLabel = BitmapKt$$ExternalSyntheticApiModelOutline0.m(shortcutInfo);
            shortcutInfoCompat.mLongLabel = BitmapKt$$ExternalSyntheticApiModelOutline0.m$1(shortcutInfo);
            shortcutInfoCompat.mDisabledMessage = BitmapKt$$ExternalSyntheticApiModelOutline0.m$2(shortcutInfo);
            if (Build.VERSION.SDK_INT >= 28) {
                shortcutInfoCompat.mDisabledReason = BitmapKt$$ExternalSyntheticApiModelOutline0.m$1(shortcutInfo);
            } else {
                shortcutInfoCompat.mDisabledReason = shortcutInfo.isEnabled() ? 0 : 3;
            }
            shortcutInfoCompat.mCategories = BitmapKt$$ExternalSyntheticApiModelOutline0.m(shortcutInfo);
            shortcutInfoCompat.mPersons = ShortcutInfoCompat.getPersonsFromExtra(BitmapKt$$ExternalSyntheticApiModelOutline0.m(shortcutInfo));
            shortcutInfoCompat.mUser = BitmapKt$$ExternalSyntheticApiModelOutline0.m(shortcutInfo);
            shortcutInfoCompat.mLastChangedTimestamp = BitmapKt$$ExternalSyntheticApiModelOutline0.m(shortcutInfo);
            if (Build.VERSION.SDK_INT >= 30) {
                shortcutInfoCompat.mIsCached = BitmapKt$$ExternalSyntheticApiModelOutline0.m(shortcutInfo);
            }
            shortcutInfoCompat.mIsDynamic = BitmapKt$$ExternalSyntheticApiModelOutline0.m$1(shortcutInfo);
            shortcutInfoCompat.mIsPinned = BitmapKt$$ExternalSyntheticApiModelOutline0.m$2(shortcutInfo);
            ...
            shortcutInfoCompat.mRank = BitmapKt$$ExternalSyntheticApiModelOutline0.m(shortcutInfo);
            shortcutInfoCompat.mExtras = BitmapKt$$ExternalSyntheticApiModelOutline0.m(shortcutInfo);
        }
