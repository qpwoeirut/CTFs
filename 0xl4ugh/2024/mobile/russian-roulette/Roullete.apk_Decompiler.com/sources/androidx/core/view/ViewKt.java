...
public final class ViewKt {
    ...
    public static final Runnable postOnAnimationDelayed(View view, long j, Function0<Unit> function0) {
        Intrinsics.checkNotNullParameter(view, "<this>");
        Intrinsics.checkNotNullParameter(function0, "action");
        ViewKt$$ExternalSyntheticLambda0 viewKt$$ExternalSyntheticLambda0 = new ViewKt$$ExternalSyntheticLambda0(function0);
        Api16Impl.postOnAnimationDelayed(view, viewKt$$ExternalSyntheticLambda0, j);
        return viewKt$$ExternalSyntheticLambda0;
    }

    /* access modifiers changed from: private */
    /* renamed from: postOnAnimationDelayed$lambda-1  reason: not valid java name */
    public static final void m27postOnAnimationDelayed$lambda1(Function0 function0) {
        Intrinsics.checkNotNullParameter(function0, "$action");
        function0.invoke();
    }
