        ...
        private void showForType(int i) {
            if (i == 1) {
                ...
                if (view != null && view.hasWindowFocus()) {
                    view.post(new WindowInsetsControllerCompat$Impl20$$ExternalSyntheticLambda0(view));
                }
            }
        }
    ...
    private static class Impl30 extends Impl {
        ...
        public void addOnControllableInsetsChangedListener(OnControllableInsetsChangedListener onControllableInsetsChangedListener) {
            if (!this.mListeners.containsKey(onControllableInsetsChangedListener)) {
                WindowInsetsControllerCompat$Impl30$$ExternalSyntheticLambda11 windowInsetsControllerCompat$Impl30$$ExternalSyntheticLambda11 = new WindowInsetsControllerCompat$Impl30$$ExternalSyntheticLambda11(this, onControllableInsetsChangedListener);
                this.mListeners.put(onControllableInsetsChangedListener, windowInsetsControllerCompat$Impl30$$ExternalSyntheticLambda11);
                this.mInsetsController.addOnControllableInsetsChangedListener(windowInsetsControllerCompat$Impl30$$ExternalSyntheticLambda11);
            }
        }
        ...
        public /* synthetic */ void m28lambda$addOnControllableInsetsChangedListener$0$androidxcoreviewWindowInsetsControllerCompat$Impl30(OnControllableInsetsChangedListener onControllableInsetsChangedListener, WindowInsetsController windowInsetsController, int i) {
        ...
        /* access modifiers changed from: package-private */
        public void removeOnControllableInsetsChangedListener(OnControllableInsetsChangedListener onControllableInsetsChangedListener) {
            WindowInsetsController.OnControllableInsetsChangedListener m = WindowInsetsCompat$Impl28$$ExternalSyntheticApiModelOutline0.m((Object) this.mListeners.remove(onControllableInsetsChangedListener));
            if (m != null) {
