...
public class Direct {
    ...
    private static void horizontalSolvingPass(int i, ConstraintWidget constraintWidget, BasicMeasure.Measurer measurer, boolean z) {
        ...
        if (!constraintWidget.isHorizontalSolvingPassDone()) {
            int i2 = hcount;
            boolean z3 = EARLY_TERMINATION;
            hcount = i2 + 1;
            if (!(constraintWidget2 instanceof ConstraintWidgetContainer) && constraintWidget.isMeasureRequested()) {
                int i3 = i + 1;
                if (canMeasure(i3, constraintWidget2)) {
                    ConstraintWidgetContainer.measure(i3, constraintWidget2, measurer2, new BasicMeasure.Measure(), BasicMeasure.Measure.SELF_DIMENSIONS);
                }
            }
            ...
            if (anchor.getDependents() != null && anchor.hasFinalValue()) {
                ...
                while (it.hasNext()) {
                    ...
                    int i4 = i + 1;
                    boolean canMeasure = canMeasure(i4, constraintWidget3);
                    if (constraintWidget3.isMeasureRequested() && canMeasure) {
                        ConstraintWidgetContainer.measure(i4, constraintWidget3, measurer2, new BasicMeasure.Measure(), BasicMeasure.Measure.SELF_DIMENSIONS);
                    }
                    boolean z4 = ((next != constraintWidget3.mLeft || constraintWidget3.mRight.mTarget == null || !constraintWidget3.mRight.mTarget.hasFinalValue()) && (next != constraintWidget3.mRight || constraintWidget3.mLeft.mTarget == null || !constraintWidget3.mLeft.mTarget.hasFinalValue())) ? false : z3;
                    if (constraintWidget3.getHorizontalDimensionBehaviour() != ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT || canMeasure) {
                        if (!constraintWidget3.isMeasureRequested()) {
                            if (next == constraintWidget3.mLeft && constraintWidget3.mRight.mTarget == null) {
                                ...
                                horizontalSolvingPass(i4, constraintWidget3, measurer2, z2);
                                ...
                                solveHorizontalCenterConstraints(i4, measurer2, constraintWidget3, z2);
                            }
                        }
                    } else if (constraintWidget3.getHorizontalDimensionBehaviour() == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT && constraintWidget3.mMatchConstraintMaxWidth >= 0 && constraintWidget3.mMatchConstraintMinWidth >= 0 && ((constraintWidget3.getVisibility() == 8 || (constraintWidget3.mMatchConstraintDefaultWidth == 0 && constraintWidget3.getDimensionRatio() == 0.0f)) && !constraintWidget3.isInHorizontalChain() && !constraintWidget3.isInVirtualLayout() && z4 && !constraintWidget3.isInHorizontalChain())) {
                        solveHorizontalMatchConstraint(i4, constraintWidget2, measurer2, constraintWidget3, z2);
                    }
            ...
            if (!(constraintWidget2 instanceof Guideline)) {
                if (anchor2.getDependents() != null && anchor2.hasFinalValue()) {
                    ...
                    while (it2.hasNext()) {
                        ...
                        int i5 = i + 1;
                        boolean canMeasure2 = canMeasure(i5, constraintWidget4);
                        if (constraintWidget4.isMeasureRequested() && canMeasure2) {
                            ConstraintWidgetContainer.measure(i5, constraintWidget4, measurer2, new BasicMeasure.Measure(), BasicMeasure.Measure.SELF_DIMENSIONS);
                        }
                        boolean z5 = (next2 == constraintWidget4.mLeft && constraintWidget4.mRight.mTarget != null && constraintWidget4.mRight.mTarget.hasFinalValue()) || (next2 == constraintWidget4.mRight && constraintWidget4.mLeft.mTarget != null && constraintWidget4.mLeft.mTarget.hasFinalValue());
                        if (constraintWidget4.getHorizontalDimensionBehaviour() != ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT || canMeasure2) {
                            if (!constraintWidget4.isMeasureRequested()) {
                                if (next2 == constraintWidget4.mLeft && constraintWidget4.mRight.mTarget == null) {
                                    ...
                                    horizontalSolvingPass(i5, constraintWidget4, measurer2, z2);
                                    ...
                                    solveHorizontalCenterConstraints(i5, measurer2, constraintWidget4, z2);
                                }
                            }
                            ...
                            if ((constraintWidget4.getVisibility() == 8 || (constraintWidget4.mMatchConstraintDefaultWidth == 0 && constraintWidget4.getDimensionRatio() == 0.0f)) && !constraintWidget4.isInHorizontalChain() && !constraintWidget4.isInVirtualLayout() && z5 && !constraintWidget4.isInHorizontalChain()) {
                                solveHorizontalMatchConstraint(i5, constraintWidget2, measurer2, constraintWidget4, z2);
                            }
                        }
                    }
                }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:98:0x01e0, code lost:
        if (r4.mListAnchors[r23].mTarget.mOwner == r0) goto L_0x01e4;
     */
