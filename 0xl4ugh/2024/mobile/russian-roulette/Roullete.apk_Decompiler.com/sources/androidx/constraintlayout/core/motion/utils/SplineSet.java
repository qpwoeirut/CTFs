...
public abstract class SplineSet {
    ...
    public void setup(int i) {
        ...
        if (i2 != 0) {
            ...
            double[][] dArr2 = (double[][]) Array.newInstance(Double.TYPE, new int[]{i3, 1});
            int i5 = 0;
    ...
    public static class CustomSet extends SplineSet {
        ...
        public void setup(int i) {
            ...
            double[][] dArr2 = (double[][]) Array.newInstance(Double.TYPE, new int[]{size, numberOfInterpolatedValues});
