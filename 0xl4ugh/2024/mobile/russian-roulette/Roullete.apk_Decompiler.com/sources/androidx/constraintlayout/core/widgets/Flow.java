        ...
        if (i10 != 0) {
            ...
            if (i2 == 0) {
                ...
                while (i13 < i10) {
                    ...
                    if ((!z && i13 > 0 && (i9 = this.mMaxElementsWrap) > 0 && i13 % i9 == 0) || z) {
                ...
                while (i17 < i10) {
                    ...
                    if ((!z2 && i17 > 0 && (i8 = this.mMaxElementsWrap) > 0 && i17 % i8 == 0) || z2) {
                        widgetsList = new WidgetsList(i2, this.mLeft, this.mTop, this.mRight, this.mBottom, i3);
        ...
        if (i10 != 0) {
            ...
            if (i2 == 0) {
                ...
                while (i14 < i10) {
                    ...
                    if ((z || i14 <= 0 || (i9 = this.mMaxElementsWrap) <= 0 || i15 <= i9) && !z) {
                ...
                while (i19 < i10) {
                    ...
                    int i20 = i4;
                    boolean z2 = (i17 == i11 || (this.mVerticalGap + i17) + widgetHeight > i11) && widgetsList.biggest != null;
                    if ((!z2 && i19 > 0 && (i8 = this.mMaxElementsWrap) > 0 && i8 < 0) || z2) {
                        widgetsList = new WidgetsList(i2, this.mLeft, this.mTop, this.mRight, this.mBottom, i3);
