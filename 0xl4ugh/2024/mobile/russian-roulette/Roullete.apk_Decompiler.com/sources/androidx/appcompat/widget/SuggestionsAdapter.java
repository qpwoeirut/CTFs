...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    private android.graphics.drawable.Drawable getDrawable(android.net.Uri r8) {
        /*
            ...
            r4 = 0
            java.lang.String r5 = r8.getScheme()     // Catch:{ FileNotFoundException -> 0x0079 }
            java.lang.String r6 = "android.resource"
            boolean r5 = r6.equals(r5)     // Catch:{ FileNotFoundException -> 0x0079 }
            if (r5 == 0) goto L_0x002c
            android.graphics.drawable.Drawable r8 = r7.getDrawableFromResourceUri(r8)     // Catch:{ NotFoundException -> 0x001a }
            return r8
        L_0x001a:
            java.io.FileNotFoundException r1 = new java.io.FileNotFoundException     // Catch:{ FileNotFoundException -> 0x0079 }
            java.lang.StringBuilder r2 = new java.lang.StringBuilder     // Catch:{ FileNotFoundException -> 0x0079 }
            r2.<init>(r3)     // Catch:{ FileNotFoundException -> 0x0079 }
            r2.append(r8)     // Catch:{ FileNotFoundException -> 0x0079 }
            java.lang.String r2 = r2.toString()     // Catch:{ FileNotFoundException -> 0x0079 }
            r1.<init>(r2)     // Catch:{ FileNotFoundException -> 0x0079 }
            throw r1     // Catch:{ FileNotFoundException -> 0x0079 }
        L_0x002c:
            android.content.Context r3 = r7.mProviderContext     // Catch:{ FileNotFoundException -> 0x0079 }
            android.content.ContentResolver r3 = r3.getContentResolver()     // Catch:{ FileNotFoundException -> 0x0079 }
            java.io.InputStream r3 = r3.openInputStream(r8)     // Catch:{ FileNotFoundException -> 0x0079 }
            if (r3 == 0) goto L_0x0067
            android.graphics.drawable.Drawable r2 = android.graphics.drawable.Drawable.createFromStream(r3, r4)     // Catch:{ all -> 0x0051 }
        ...
        L_0x0040:
            ...
            r5.<init>(r1)     // Catch:{ FileNotFoundException -> 0x0079 }
            r5.append(r8)     // Catch:{ FileNotFoundException -> 0x0079 }
            java.lang.String r1 = r5.toString()     // Catch:{ FileNotFoundException -> 0x0079 }
            android.util.Log.e(r0, r1, r3)     // Catch:{ FileNotFoundException -> 0x0079 }
        L_0x0050:
            return r2
        L_0x0051:
            r2 = move-exception
        ...
        L_0x0056:
            ...
            android.util.Log.e(r0, r1, r3)     // Catch:{ FileNotFoundException -> 0x0079 }
        L_0x0066:
            throw r2     // Catch:{ FileNotFoundException -> 0x0079 }
        L_0x0067:
            java.io.FileNotFoundException r1 = new java.io.FileNotFoundException     // Catch:{ FileNotFoundException -> 0x0079 }
            java.lang.StringBuilder r3 = new java.lang.StringBuilder     // Catch:{ FileNotFoundException -> 0x0079 }
            r3.<init>(r2)     // Catch:{ FileNotFoundException -> 0x0079 }
            r3.append(r8)     // Catch:{ FileNotFoundException -> 0x0079 }
            java.lang.String r2 = r3.toString()     // Catch:{ FileNotFoundException -> 0x0079 }
            r1.<init>(r2)     // Catch:{ FileNotFoundException -> 0x0079 }
            throw r1     // Catch:{ FileNotFoundException -> 0x0079 }
        L_0x0079:
            r1 = move-exception
