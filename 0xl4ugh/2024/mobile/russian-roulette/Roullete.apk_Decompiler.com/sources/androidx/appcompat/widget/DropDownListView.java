...
class DropDownListView extends ListView {
    ...
    public int measureHeightOfChildrenCompat(int i, int i2, int i3, int i4, int i5) {
        ...
        while (i8 < count) {
            ...
            if (layoutParams.height > 0) {
                i6 = View.MeasureSpec.makeMeasureSpec(layoutParams.height, BasicMeasure.EXACTLY);
            } else {
    ...
    static class Api30Impl {
        ...
        static void positionSelectorForHoveredItem(DropDownListView dropDownListView, int i, View view) {
            try {
                sPositionSelector.invoke(dropDownListView, new Object[]{Integer.valueOf(i), view, false, -1, -1});
