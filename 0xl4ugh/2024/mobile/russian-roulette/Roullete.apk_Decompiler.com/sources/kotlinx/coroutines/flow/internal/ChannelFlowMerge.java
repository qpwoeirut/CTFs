...
public final class ChannelFlowMerge<T> extends ChannelFlow<T> {
    ...
    public /* synthetic */ ChannelFlowMerge(Flow flow2, int i, CoroutineContext coroutineContext, int i2, BufferOverflow bufferOverflow, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        this(flow2, i, (i3 & 4) != 0 ? EmptyCoroutineContext.INSTANCE : coroutineContext, (i3 & 8) != 0 ? -2 : i2, (i3 & 16) != 0 ? BufferOverflow.SUSPEND : bufferOverflow);
    }

    public ChannelFlowMerge(Flow<? extends Flow<? extends T>> flow2, int i, CoroutineContext coroutineContext, int i2, BufferOverflow bufferOverflow) {
