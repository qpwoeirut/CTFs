...
public class LinkedListChannel<E> extends AbstractChannel<E> {
    ...
    public void m1678onCancelIdempotentListww6eGU(Object obj, Closed<?> closed) {
        ...
        if (obj != null) {
            if (!(obj instanceof ArrayList)) {
                ...
                if (size >= 0) {
                    UndeliveredElementException undeliveredElementException3 = null;
                    while (true) {
                        int i = size - 1;
                        ...
                        if (send2 instanceof AbstractSendChannel.SendBuffered) {
                            ...
                            undeliveredElementException3 = function12 == null ? null : OnUndeliveredElementKt.callUndeliveredElementCatchingException(function12, ((AbstractSendChannel.SendBuffered) send2).element, undeliveredElementException3);
                        } else {
                    ...
                    undeliveredElementException = undeliveredElementException3;
                }
            } else {
