    ...
    private static final class Subscriber<E> extends AbstractChannel<E> implements ReceiveChannel<E> {
        ...
        public java.lang.Object pollInternal() {
            /*
                ...
                r0.lock()
                java.lang.Object r1 = r6.peekUnderLock()     // Catch:{ all -> 0x0046 }
                boolean r2 = r1 instanceof kotlinx.coroutines.channels.Closed     // Catch:{ all -> 0x0046 }
                if (r2 == 0) goto L_0x0010
                goto L_0x0014
            L_0x0010:
                kotlinx.coroutines.internal.Symbol r2 = kotlinx.coroutines.channels.AbstractChannelKt.POLL_FAILED     // Catch:{ all -> 0x0046 }
                if (r1 != r2) goto L_0x0016
            L_0x0014:
                r2 = 0
                goto L_0x0021
            L_0x0016:
                long r2 = r6.getSubHead()     // Catch:{ all -> 0x0046 }
                r4 = 1
                long r2 = r2 + r4
                r6.setSubHead(r2)     // Catch:{ all -> 0x0046 }
                r2 = 1
            L_0x0021:
                r0.unlock()
            ...
            L_0x003f:
                kotlinx.coroutines.channels.ArrayBroadcastChannel<E> r0 = r6.broadcastChannel
                r2 = 3
                kotlinx.coroutines.channels.ArrayBroadcastChannel.updateHead$default(r0, r3, r3, r2, r3)
            L_0x0045:
                return r1
            L_0x0046:
                r1 = move-exception
