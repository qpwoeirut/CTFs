    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            try {
                ...
                obj2 = Result.m165constructorimpl(ResultKt.createFailure(th));
            }
        } else {
            throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
        }
        obj2 = Result.m165constructorimpl(Unit.INSTANCE);
        if (Result.m172isSuccessimpl(obj2)) {
            obj3 = ChannelResult.Companion.m1675successJP2dKIU(Unit.INSTANCE);
        } else {
            obj3 = ChannelResult.Companion.m1673closedJP2dKIU(Result.m168exceptionOrNullimpl(obj2));
        }
        return ChannelResult.m1660boximpl(obj3);
    }
}
