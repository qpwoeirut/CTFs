        ...
        if (!DebugKt.getASSERTIONS_ENABLED() || isSelected()) {
            while (true) {
                ...
                if (obj2 == SelectKt.UNDECIDED) {
                    if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(_result$FU, this, SelectKt.UNDECIDED, CompletionStateKt.toState$default(obj, (Function1) null, 1, (Object) null))) {
                        return;
                    }
                    ...
                    if (Result.m171isFailureimpl(obj)) {
                        Continuation<R> continuation = this.uCont;
                        Throwable r4 = Result.m168exceptionOrNullimpl(obj);
                        Intrinsics.checkNotNull(r4);
                        Result.Companion companion = Result.Companion;
                        if (DebugKt.getRECOVER_STACK_TRACES() && (continuation instanceof CoroutineStackFrame)) {
                            r4 = StackTraceRecoveryKt.recoverFromStackFrame(r4, (CoroutineStackFrame) continuation);
                        }
                        continuation.resumeWith(Result.m165constructorimpl(ResultKt.createFailure(r4)));
                        return;
                    }
        ...
        if (!DebugKt.getASSERTIONS_ENABLED() || isSelected()) {
            while (true) {
                ...
                if (obj == SelectKt.UNDECIDED) {
                    ...
                    Result.Companion companion = Result.Companion;
                    intercepted.resumeWith(Result.m165constructorimpl(ResultKt.createFailure(th)));
                    return;
                }
            }
        } else {
