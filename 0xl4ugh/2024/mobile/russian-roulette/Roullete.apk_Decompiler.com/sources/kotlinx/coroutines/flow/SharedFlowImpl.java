...
public class SharedFlowImpl<T> extends AbstractSharedFlow<SharedFlowSlot> implements MutableSharedFlow<T>, CancellableFlow<T>, FusibleFlow<T> {
    ...
    public boolean tryEmit(T t) {
        ...
        while (i < length) {
            ...
            if (continuation != null) {
                ...
                continuation.resumeWith(Result.m165constructorimpl(Unit.INSTANCE));
            }
        }
        return z;
    }
    ...
    public final Continuation<Unit>[] updateCollectorIndexLocked$kotlinx_coroutines_core(long j) {
        ...
        if (DebugKt.getASSERTIONS_ENABLED() && j < this.minCollectorIndex) {
            throw new AssertionError();
        } else if (j > this.minCollectorIndex) {
            ...
            if (DebugKt.getASSERTIONS_ENABLED() && j2 < this.minCollectorIndex) {
                throw new AssertionError();
            } else if (j2 <= this.minCollectorIndex) {
                return AbstractSharedFlowKt.EMPTY_RESUMES;
            } else {
                ...
                long j10 = getNCollectors() == 0 ? bufferEndIndex : j2;
    ...
    private final void updateBufferLocked(long j, long j2, long j3, long j4) {
        ...
        if (!DebugKt.getASSERTIONS_ENABLED() || min >= getHead()) {
            ...
            if (DebugKt.getASSERTIONS_ENABLED() && this.bufferSize < 0) {
                ...
                throw new AssertionError();
            } else if (DebugKt.getASSERTIONS_ENABLED() && this.replayIndex > getHead() + ((long) this.bufferSize)) {
                throw new AssertionError();
            }
        } else {
            throw new AssertionError();
    ...
    public final Object emitSuspend(T t, Continuation<? super Unit> continuation) {
        ...
        while (i < length) {
            ...
            if (continuation2 != null) {
                ...
                continuation2.resumeWith(Result.m165constructorimpl(Unit.INSTANCE));
            }
        }
