...
public abstract class EventLoopImplBase extends EventLoopImplPlatform implements Delay {
    ...
    public long processNextEvent() {
        ...
        L_0x0031:
            ...
            monitor-enter(r3)
            kotlinx.coroutines.internal.ThreadSafeHeapNode r7 = r3.firstImpl()     // Catch:{ all -> 0x005e }
            if (r7 != 0) goto L_0x003e
            monitor-exit(r3)
            r7 = r4
            goto L_0x0059
        L_0x003e:
            kotlinx.coroutines.EventLoopImplBase$DelayedTask r7 = (kotlinx.coroutines.EventLoopImplBase.DelayedTask) r7     // Catch:{ all -> 0x005e }
            boolean r8 = r7.timeToExecute(r5)     // Catch:{ all -> 0x005e }
            if (r8 == 0) goto L_0x0054
            java.lang.Runnable r7 = (java.lang.Runnable) r7     // Catch:{ all -> 0x005e }
            boolean r7 = r9.enqueueImpl(r7)     // Catch:{ all -> 0x005e }
            if (r7 == 0) goto L_0x0054
            r7 = 0
            kotlinx.coroutines.internal.ThreadSafeHeapNode r7 = r3.removeAtImpl(r7)     // Catch:{ all -> 0x005e }
            goto L_0x0058
        L_0x0054:
            r7 = r4
            kotlinx.coroutines.internal.ThreadSafeHeapNode r7 = (kotlinx.coroutines.internal.ThreadSafeHeapNode) r7     // Catch:{ all -> 0x005e }
            r7 = r4
        L_0x0058:
            monitor-exit(r3)
        L_0x0059:
