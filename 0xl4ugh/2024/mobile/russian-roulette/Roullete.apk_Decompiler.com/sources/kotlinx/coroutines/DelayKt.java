...
public final class DelayKt {
    ...
    public static final Object m1641delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m1642toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m1642toDelayMillisLRDsOJo(long j) {
        if (Duration.m1476compareToLRDsOJo(j, Duration.Companion.m1579getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1495getInWholeMillisecondsimpl(j), 1);
        }
        return 0;
    }
}
