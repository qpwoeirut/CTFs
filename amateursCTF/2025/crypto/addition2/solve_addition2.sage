...
n = 
c1 = 
c2 = 
# ----------------------------
...
R_mod_n.<x, y> = PolynomialRing(Integers(n))
...
roots = small_roots(R_mod_n_xy, (X_bound, Y_bound), m=4)
...
r1, r2 = [Integer(val) for val in roots[0]]
...
P_z.<z> = PolynomialRing(Integers(n))
