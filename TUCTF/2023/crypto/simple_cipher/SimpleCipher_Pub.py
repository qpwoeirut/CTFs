...
def substitution(ptext): ##DONE
    ...
    # for testing
    pattern = [12, 34, 43, 15, 17, 10, 27, 19, 40, 38, 42, 26, 45, 22, 6, 1, 46, 5, 18, 44, 30, 24, 14, 3, 7, 4, 28, 0, 36, 41, 25, 39, 23, 29, 8, 16, 33, 47, 32, 9, 2, 31, 21, 20, 35, 13, 37, 11]
    scrambled = ''
    for i in pattern:
...
def unscramble(scrambled_text): ##DONE
    ...
    # for testing
    revPattern = [27, 15, 40, 23, 25, 17, 14, 24, 34, 39, 5, 47, 0, 45, 22, 3, 35, 4, 18, 7, 43, 42, 13, 32, 21, 30, 11, 6, 26, 33, 20, 41, 38, 36, 1, 44, 28, 46, 9, 31, 8, 29, 10, 2, 19, 12, 16, 37]
    unscrambled_text=''
    for i in revPattern:
